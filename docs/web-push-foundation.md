...
| 1-6 | 生徒向け通知設定画面 |
| 1-7 | 送信基盤・テスト通知 |
| 2-1 | 未記録リマインダー調査・統合設計（実装なし）→ [web-push-study-reminder-integration.md](./web-push-study-reminder-integration.md) |
| 第2段階（2-2〜） | 学習リマインダー Push-first 実装、他通知接続、メールフォールバック |
