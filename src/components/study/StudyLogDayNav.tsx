...
export function StudyLogDayNav({
  ...
  const navButtonClass =
    'relative inline-flex min-h-11 min-w-[4.5rem] items-center justify-center gap-1.5 rounded-lg border border-border bg-background px-3 text-sm font-medium transition hover:bg-card active:scale-[0.92] active:border-primary/40 active:bg-primary/10'
