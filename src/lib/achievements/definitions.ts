...
export const ACHIEVEMENTS: AchievementDefinition[] = [
  ...
  },
  {
    id: 'vocab_3h',
    title: '覚えなきゃ...',
    description: '「単語・熟語」「単語」タグの教材の学習時間が3時間を突破',
    stars: 1,
    category: 'total',
  },
  {
    id: 'vocab_30h',
    title: 'まだまだ...',
    description: '「単語・熟語」「単語」タグの教材の学習時間が30時間を突破',
    stars: 1,
    category: 'total',
  },
  {
    id: 'vocab_75h',
    title: 'これから...',
    description: '「単語・熟語」「単語」タグの教材の学習時間が75時間を突破',
    stars: 2,
    category: 'total',
  },
  {
    id: 'vocab_200h',
    title: 'もっともっと...',
    description: '「単語・熟語」「単語」タグの教材の学習時間が200時間を突破',
    stars: 3,
    category: 'total',
  },
  {
    id: 'vocab_500h',
    title: '生き字引',
    description: '「単語・熟語」「単語」タグの教材の学習時間が500時間を突破',
    stars: 4,
    category: 'total',
  },
  {
