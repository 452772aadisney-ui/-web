...
describe('free-text subject', () => {
  it('accepts custom subjects and rejects blank', () => {
...
describe('time grid', () => {
  ...
  it('preserves off-grid originals when unchanged', () => {
    expect(
      isAllowedClassScheduleTimePair({
        start: '10:03',
        end: '11:07',
...
describe('057 migration static', () => {
  ...
  it('adds location_details, keeps legacy columns, replaces with 5-arg RPC', () => {
